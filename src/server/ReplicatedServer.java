...
public class ReplicatedServer extends SingleServer {
    ...
    public ReplicatedServer(NodeConfig<String> nodeConfig, String myID,
    	...
    	// System.out.println("printing nodeConfig "+nodeConfig);
    	// System.out.println("printing my id "+myID);
    	// System.out.println("printing isaDB "+isaDB);
    ...
    public static void main(String[] args) throws IOException {
        if(args.length>1)
            for(int i=1; i<args.length; i++) {
            	// System.out.println("printing line 1 "+ args[i].trim());
