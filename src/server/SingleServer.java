...
public class SingleServer {
    ...
    public SingleServer(InetSocketAddress isa, InetSocketAddress isaDB, String
    	...
    	// System.out.println("printing from single server "+isa);
    	// System.out.println("printing from single server "+isaDB);
    	// System.out.println("printing from single server "+keyspace);
